...
import com.shuishu.face.openvisual.server.mapper.dynamic.DynamicSampleDataProvider;
...
public interface SampleDataMapper {
    ...
    @SelectProvider(type = DynamicSampleDataProvider.class, method = "findSamplePage")
    IPage<Map<String, Object>> findSamplePage(Page<?> page, @Param("table") String table);
